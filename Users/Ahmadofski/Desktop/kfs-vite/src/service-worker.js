...
importScripts('./libs/isomorphicgit129.js');
importScripts('./libs/LightningFS.js');
importScripts('./libs/GitHttp.js');
importScripts('./libs/workerUtils/Logger.js')
importScripts('./libs/swUtils/memoryBackend-global.js')
importScripts('./libs/swUtils/fsManager-global.js');
