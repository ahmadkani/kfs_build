import { MemoryFS } from './assets/memoryFs-CMm_oKmM.js';
import { g as getConfig, L as Logger, w as workerPool } from './assets/WorkerPool-iBgrosFL.js';
  ...
  async createFSInstance(fsType, mountPath, options = {}) {
    ...
    try {
      ...
      if (isNode && fsType === 'node') {
          ...
          const { NodeFS } = await import('./assets/NodeFS-DpEZohL0.js');
      ...
      switch (fsType) {
        case 'memory':
          ...
          const { MemoryFS } = await import('./assets/memoryFs-CMm_oKmM.js');
          fsInstance = new MemoryFS(mountPath, { ...options, useSW: false });
          break;
        case 'idb':
          consoleDotLog$2('Creating IDBFs instance');
          const { IDBFs } = await import('./assets/IDBFs-nsNPj8hU.js');
